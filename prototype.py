...
# -------------------------------
# Configurations
data_folder = "C:\\Users\\onsbe\\Desktop\\Chatbot-RAG\\data\\TRAIN_TXT"
db_connection_str = "dbname='rag_chatbot' user='postgres' password='ons' host='localhost' port='5432'"
embedding_model_name = "BAAI/bge-large-en"
genai.configure(api_key="AIzaSyBe1RxmNTSgYcVGjEA9fRHdl4pGcU3_KJU")  # Ton API Key
...
with psycopg.connect(db_connection_str) as conn:
    with conn.cursor(row_factory=dict_row) as cur:
        user_question = "Je veux connetre les formations disponible pour le niveau master?"
